...
def main():
    ...
    config = {
        ...
        "end_date": "2024-01-16",
        "interval_days": 1, 
        "query_template": "repo:{repo} is:pr created:{start_date}..{end_date}",
        "output_file": None
    }
    ...
    print(f"Interval days: {config['interval_days']}")
    ...
    save_json(all_prs, total_metrics, config["output_file"], config["repo"], config["start_date"], config["end_date"])
